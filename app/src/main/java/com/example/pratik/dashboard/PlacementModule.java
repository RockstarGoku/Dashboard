...
public class PlacementModule extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_placement_module);
        ...
        sendMessage.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View view) {
                ...
                Intent intent = new Intent(PlacementModule.this,RecyclerViewForMessages.class);
                startActivity(intent);
