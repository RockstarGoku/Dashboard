...
public class SportsUI extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_sports_ui);
        ...
        sendMessage.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View view) {
                ...
                Intent intent = new Intent(SportsUI.this,RecyclerViewForMessages.class);
                startActivity(intent);
